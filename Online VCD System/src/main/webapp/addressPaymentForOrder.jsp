...
%>
        ...
        <tbody>
        <%
      ResultSet rs=st.executeQuery("select * from vcddetails inner join cart on vcddetails.vcdid=cart.product_id and cart.email='"+email+"' and cart.address is NULL");
      while(rs.next())
      {
      %>  
          <tr>
...
<div class="right-div">
<h3>Pay online  UPI ID - onlinevcdsystem@ybl</h3>
