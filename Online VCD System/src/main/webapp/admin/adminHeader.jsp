...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String email=session.getAttribute("email").toString(); %>
            <center><h2>Online VCDs System</h2></center>
            <a href="addNewStore.jsp">Add New Store <i class='fas fa-plus-square'></i></a>
            <a href="addNewProduct.jsp">Add New Product <i class='fas fa-plus-square'></i></a>
            <a href="allVCDStoreEdit.jsp">View & Modify VCD Stores <i class='fab fa-elementor'></i></a>
