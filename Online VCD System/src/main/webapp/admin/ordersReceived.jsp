...
<table id="customers">
        ...
        try{
             ...
             ResultSet rs=st.executeQuery("select * from cart inner join vcddetails on cart.product_id=vcddetails.vcdid and cart.orderDate is not NULL and cart.status='processing'");
             while(rs.next())
             {
        %>
