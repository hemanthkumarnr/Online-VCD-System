...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <%String email=session.getAttribute("email").toString(); %>
            ...
            <h2><a href="homeStore.jsp"><%out.println(email);%> <i class='fas fa-user-alt'></i></a></h2>
            <a href="homeStore.jsp">Home<i class="fa fa-institution"></i></a>
            ...
            <div class="search-container">
             <form action="searchHome.jsp" action="post">
